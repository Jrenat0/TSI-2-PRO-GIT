        ...
        <form action="{{ route('mascotas.update', $mascota) }}" method="POST" id="formEdit">
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    is-invalid @enderror"
                        id="nombre" name="nombre" placeholder="Ingrese el nombre de la mascota" required
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="text" class="form-control @error('raza') is-invalid @enderror" id="raza"
                        name="raza" placeholder="Ingrese el raza" required value="{{ old('raza', $mascota->raza) }}">
                    @error('raza')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="text" class="form-control @error('sexo') is-invalid @enderror" id="sexo"
                        name="sexo" placeholder="Ingrese el sexo" required value="{{ old('sexo', $mascota->sexo) }}">
                    @error('sexo')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="text" class="form-control @error('color') is-invalid @enderror" id="color"
                        name="color" placeholder="Ingrese el color" required value="{{ old('color', $mascota->color) }}">
                    @error('color')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-12 mb-4">
                    ...
                    <input type="number" class="form-control @error('peso') is-invalid @enderror" id="peso"
                        name="peso" step="0.1" placeholder="Ingrese el peso"
